...
| Complete authenticated mutation audit | Real HTTP attempts (including malformed/forbidden attempts) reach durable, value-free Audit exactly once | Gateway rejection gap remains |
