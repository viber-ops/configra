...
The rotation deferral below is superseded by [ADR-0032](0032-rotate-local-master-keys-offline.md). Its separate-backup and key-custody requirements still apply.
